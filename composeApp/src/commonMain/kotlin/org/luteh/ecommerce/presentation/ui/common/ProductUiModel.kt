...
data class ProductUiModel(
    ...
    val description: String = "Experience premium quality with this outstanding product. Designed for comfort and durability, it features state-of-the-art materials and a sleek modern design perfect for any occasion."
)

val dummyProducts = listOf(
    ProductUiModel("1", "Wireless Headphones", "$129.99", 4.5, Color(0xFFE57373), "Electronics"),
    ProductUiModel("2", "Smart Watch Series 7", "$399.00", 4.8, Color(0xFF81C784), "Electronics"),
    ...
    ProductUiModel("8", "Mechanical Keyboard", "$119.00", 4.7, Color(0xFF4DD0E1), "Electronics"),
